...
export default function Footer() {
  return (
    <footer className="font-inter pt-12 pb-4 text-gray-700">
      <div className="max-w-screen-lg mx-auto px-4 md:px-0 text-center">
        <div className="flex flex-col justify-between items-center mb-8 md:flex-row">
          ...
          <div className="flex-shrink-0 mb-16 md:mb-0">
            <img src={Aloud} alt="Aloud Logo" className="w-[122px] mx-auto md:w-24" />
          </div>

      
          <div className="flex flex-col text-left gap-16 md:flex-row md:gap-32">
            <div>
              <h4 className="pb-6 text-[#9B9B9B] text-[22px] font-semibold">Company</h4>
            ...
            <div>
              <h4 className="pb-6 text-[#9B9B9B] text-[22px] font-semibold">Resources</h4>
              <ul className="space-y-2 font-semibold">
            ...
            <div>
              <h4 className="pb-6 text-[#9B9B9B] text-[22px] font-semibold">Legal</h4>
              <ul className="space-y-2 font-semibold">
      ...
      <hr className="border-gray-300 my-4 w-full  md:block" />


      <div className="flex flex-col max-w-screen-lg mx-auto px-4 md:px-0 text-center md:text-left">
