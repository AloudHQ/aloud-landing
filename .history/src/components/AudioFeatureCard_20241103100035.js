    ...
    <div className="flex justify-center items-center -mt-32 min-h-screen">
      <div className="h-[536px] mb-4 bg-[#E6E8FF] font-inter rounded-[27px] py-8 px-16 flex flex-col justify-between items-center w-[340px] md:w-[1024px] md:h-[540px] md:flex-row">
        <div className="max-w-md text-center md:text-left">
          <h3 className="text-[32px] font-medium -tracking-3 text-black mb-1 mx-auto md:w-full md:whitespace-normal md:leading-[1.2] md:mx-0 md:text-[45px]">
            Voice-Only: <br/> A Bridge for All
          </h3>
          <p className="text-[18px] text-[#858180] -tracking-2 mb-1">
          ...
          <button className="bg-[#8289FC] w-[223px] h-[62px] text-white py-3 px-6 rounded-full text-lg hidden sm:block mt-1">
            Read Blog
          </button>
        </div>
